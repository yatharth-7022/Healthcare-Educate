        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/profile.php?id=61559483153760"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/smashmedgamsatprep/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-primary/10 hover:text-primary transition-all"
              >
              ...
              <a
                href="https://medium.com/@smashmedproductions"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-primary/10 hover:text-primary transition-all"
              >
          ...
          {/* Links Columns */}
          <div>
            <h4 className="font-bold text-gray-900 mb-6 font-heading">
              Platform
            </h4>
